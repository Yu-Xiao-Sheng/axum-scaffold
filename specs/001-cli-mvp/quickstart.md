# Developer Quick Start Guide: create-axum-app CLI Tool

**Date**: 2025-02-05
**Audience**: Developers working on the create-axum-app CLI tool
...
git clone https://github.com/your-org/create-axum-app.git
cd create-axum-app
...
# Check binary size
ls -lh target/release/create-axum-app
...
cargo flamegraph --bin create-axum-app -- test-app
...
gh release create v1.0.0 \
    ...
    target/release/create-axum-app
```
