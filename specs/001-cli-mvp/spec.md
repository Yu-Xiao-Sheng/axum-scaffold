# Feature Specification: create-axum-app CLI Tool - Phase 1 MVP

**Feature Branch**: `001-cli-mvp`
**Created**: 2025-02-05
**Status**: Draft
**Input**: User description: "create-axum-app CLI tool - Phase 1 MVP
...
- **FR-020B**: The tool MUST automatically initialize a Git repository in the generated project:
  ...
  - Create an initial commit with the message "Initial project generated by create-axum-app"
...
- The tool is distributed via crates.io and installed using `cargo install create-axum-app`
...
- Q: How should the CLI tool be distributed and installed? → A: crates.io publication - Install via `cargo install create-axum-app` (standard Rust pattern, no external infrastructure)
