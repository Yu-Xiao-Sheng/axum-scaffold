# Phase 0 Research: create-axum-app CLI Tool - Phase 1 MVP
...
- Create initial commit with message: "Initial project generated by create-axum-app"
...
fn init_git(project_dir: &Path) -> Result<()> {
    ...
    let sig = Signature::now("Generator", "generator@create-axum-app")?;
...
Generated by [create-axum-app](https://github.com/...).
...
**Chosen Approach**:
- Publish via crates.io as `create-axum-app`
- Installation: `cargo install create-axum-app`
