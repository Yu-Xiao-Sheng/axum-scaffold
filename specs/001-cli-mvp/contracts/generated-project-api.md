...
**Purpose**: Define the HTTP API surface of projects generated by create-axum-app

## Overview

Projects generated by create-axum-app expose a RESTful HTTP API built with Axum. This contract defines the standard endpoints, request/response formats, error handling, and authentication mechanisms.
